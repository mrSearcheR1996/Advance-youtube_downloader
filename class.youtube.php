<?php
/**
 * Tutsplanet and mrsearcher1996 Edited
 *
 * This class narrates the functions to support download a video from YouTube
 * @class YouTubeDownloader
 * @author Tutsplanet , Edited and upgrade by mrsearcher1996
 *
 */
...
Class YouTubeDownloader {
    ...
    public function processVideo($vid) {
         ...
         $dt = file_get_contents("https://www.youtube.com/get_video_info?video_id=$vid");
 ...
 if (strpos($dt, 'status=fail') !== false) {
    ...
    //Get Videos Info : 
        $playabilityJson =json_decode(urldecode($t['player_response']));
